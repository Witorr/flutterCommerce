...
class TTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    bodySmall: const TextStyle().copyWith(fontSize: 14.0, fontWeight: FontWeight.w500, color: Colors.black.withOpacity(0.6)),
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    bodySmall: const TextStyle().copyWith(fontSize: 14.0, fontWeight: FontWeight.w500, color: Colors.white.withOpacity(0.6)),
